...
__Key Shakeholders:__

_  Lily Moreno

_ Cyclistic marketing analytics team

_ Cyclistic executive team

__Business Task:__

Utilize the data to investigate and gain understanding of how annual members and casual riders utilize Cyclistic bikes differently. Assist the team in putting marketing strategies in place that will use the learned information to turn casual riders into annual members.

# Prepare
The data includes information about Cyclistic's ride trips and customers' pattern in bike usage. The data acquired ranges from January 2019 to March 2020.

Link [Data Source](https://divvy-tripdata.s3.amazonaws.com/index.html)

# Process

R programming tool will be primarily used for data wrangling, analysis and visualization

## Data Preparation

__First, we will have to import tidyverse, lubridate, skimr, janitor and ggplot2 packages to work with our data more efficiently.__
...
__Import the data files from January 2019 to March 2020:__
...
__Check column names before merging the data__
...
__Renaming the other columns to be uniform with Q1_2020 since it's the most recent data__
...
__Selecting the columns we need for analysis from the dataframe__
